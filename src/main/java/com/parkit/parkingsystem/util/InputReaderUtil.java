...
/**
 * Contains methods that return the user inputs
 */
public class InputReaderUtil {
	 ...
	 * 
	 * @return int
	 * @throws Exception if error while reading the input user, or the input is
	 *                   invalid
	 */
	...
	/**
	 * Returns a String corresponding to the vehicle registration number written by
	 * the user.
	 * 
